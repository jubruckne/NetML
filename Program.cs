...
var gguf = GGUF.from_file("../../../../../models/gpt2_127-fp32.gguf");

foreach (var kv in gguf.metadata.keys_and_values) Console.WriteLine($"{kv.key} = {kv.value}");
foreach (var t in gguf.tensors) Console.WriteLine(t);

GPT2 gpt = new(ctx, gguf);
